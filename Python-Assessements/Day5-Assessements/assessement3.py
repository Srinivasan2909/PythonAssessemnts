...
d1 = Checkbutton(frame4, text = "Python", variable = var1, onvalue = 1, offvalue = 0, command = m.getval)
d2 = Checkbutton(frame4, text = "C#Dot NEt", variable = var2, onvalue = 1, offvalue = 0, command = m.getval)
